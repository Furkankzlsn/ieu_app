    ...
    const realNewsData = {
      news: {
        "1": {
          ...
          ozet: "İzmir Ekonomi Üniversitesi (IEU) Genetik ve Biyomühendislik Bölümü'nde eğitim gören gençler, başarılı çalışmalarıyla dünyaca ünlü üniversitelerin ilk tercihi oldu.",
          icerik: `<article><div class="news-content"><h1>'Gen'lerinde Başarı Var</h1><p>İzmir Ekonomi Üniversitesi (IEU) Genetik ve Biyomühendislik Bölümü'nde eğitim gören gençler, başarılı çalışmalarıyla dünyaca ünlü üniversitelerin ilk tercihi oldu.</p><p>Genetik ve Biyomühendislik alanında gerçekleştirdikleri çalışmalarla dikkat çeken öğrenciler, uluslararası düzeyde tanınırlık kazandı.</p><p>Bu başarı, İzmir Ekonomi Üniversitesi'nin bilimsel çalışmalardaki gücünü bir kez daha ortaya koyuyor.</p></div></article>`,
        ...
        "2": {
          ...
          ozet: "İzmir Ekonomi Üniversitesi (IEU) Elektrik-Elektronik Mühendisliği Bölümü Dr. Öğretim Üyesi Ayça Kumluca Topallı, TÜBİTAK'ın 7.5 milyon liralık desteğiyle hayata geçen 'Yapay zeka destekli akıllı üretim asistanı' projesinin paydaşı oldu.",
          icerik: `<article><div class="news-content"><h1>Akıllı Üretim için Örnek Proje</h1><p>İzmir Ekonomi Üniversitesi (IEU) Elektrik-Elektronik Mühendisliği Bölümü Dr. Öğretim Üyesi Ayça Kumluca Topallı, TÜBİTAK'ın 7.5 milyon liralık desteğiyle hayata geçen 'Yapay zeka destekli akıllı üretim asistanı' projesinin paydaşı oldu.</p><p>Proje kapsamında, yapay zeka teknolojileri kullanılarak üretim süreçlerinde verimliliği artırmayı hedefleyen yenilikçi çözümler geliştirilecek.</p><p>Bu proje, Türkiye'nin Endüstri 4.0 dönüşümüne katkı sağlayacak önemli adımlardan biri olacak.</p></div></article>`,
        ...
        "5": {
          ...
          ozet: "İzmir Ekonomi Üniversitesi (IEU) İngilizce Mütercim ve Tercümanlık Bölümü'nden mezun olduktan sonra yüksek lisans için Güney Kore'yi tercih eden Aybüke Cihan (25), başarılarıyla yıldızlaştı.",
          icerik: `<article><div class="news-content"><h1>Güney Kore'ye 'İzmir Ekonomi' İmzası</h1><p>İzmir Ekonomi Üniversitesi (IEU) İngilizce Mütercim ve Tercümanlık Bölümü'nden mezun olduktan sonra yüksek lisans için Güney Kore'yi tercih eden Aybüke Cihan (25), başarılarıyla yıldızlaştı.</p><p>Güney Kore'de eğitimine devam eden mezunumuz, İzmir Ekonomi Üniversitesi'nin küresel başarı hikayelerinden birine imza attı.</p><p>Bu başarı, üniversitemizin uluslararası tanınırlığının ve mezunlarımızın kalitesinin göstergesidir.</p></div></article>`,
        ...
        "6": {
          ...
          ozet: "İzmir Ekonomi Üniversitesi (IEU) İşletme Fakültesi Siyaset Bilimi ve Uluslararası İlişkiler Bölümü'nden bu yıl mezun olan Can Arıkan ve Cenker Karagöz, Avrupa Birliği tarafından sayılı gence verilen 'Jean Monnet' bursunu almaya hak kazandı.",
          icerik: `<article><div class="news-content"><h1>İzmir Ekonomi'den Avrupa'ya</h1><p>İzmir Ekonomi Üniversitesi (IEU) İşletme Fakültesi Siyaset Bilimi ve Uluslararası İlişkiler Bölümü'nden bu yıl mezun olan Can Arıkan ve Cenker Karagöz, Avrupa Birliği tarafından sayılı gence verilen 'Jean Monnet' bursunu almaya hak kazandı.</p><p>Jean Monnet bursu, Avrupa entegrasyonu konusunda çalışmak isteyen gençlere verilen prestijli bir destektir.</p><p>Bu başarı, üniversitemizin Avrupa Birliği ilişkilerindeki gücünü göstermektedir.</p></div></article>`,
